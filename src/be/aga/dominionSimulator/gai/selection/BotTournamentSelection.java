package be.aga.dominionSimulator.gai.selection;
...
public class BotTournamentSelection implements
		SelectionStrategy<List<DomBuyRule>> {
     ...
     */
    public BotTournamentSelection(NumberGenerator<Probability> selectionProbability)
    {
     ...
     */
    public BotTournamentSelection(Probability selectionProbability)
    {
	...
	@Override
	public <S extends List<DomBuyRule>> List<S> select(
